...
namespace RealEstate_Dapper_Api.Repositories.WhoWeAreRepository
{
    public class WhoWeAreDetailRepository : IWhoWeAreDetailRepository
    {
        ...
        public async Task<List<ResultWhoWeAreDetailDto>> GetAllResultWhoWeAreDetailAsync()
        {
        ...
        {
            string query = "Update WhoWeAreDetail Set Title=@title,Subtitle=@subTitle,Description1 = @description1,Description2=@descriptions2 where WhoWeAreDetailID = @whoWeAreDetailID";
            var parameters = new DynamicParameters();
